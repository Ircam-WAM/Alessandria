...
class Book(ModelEntity):
    ...
    classif_mark = models.CharField(_("Classification mark"), max_length=256, null=True, blank=True)
    manufacturer_ref = models.CharField(_("Manufacturer Reference"), max_length=256, null=True, blank=True)
