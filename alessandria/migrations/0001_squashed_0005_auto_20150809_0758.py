...
class Migration(migrations.Migration):
    ...
    replaces = [('alessandria', '0001_initial'), ('alessandria', '0002_auto_20150801_1710'), ('alessandria', '0003_author_alias'), ('alessandria', '0004_auto_20150807_0629'), ('alessandria', '0005_auto_20150809_0758')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='alessandria_author_add', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(blank=True, to=settings.AUTH_USER_MODEL, null=True, related_name='alessandria_author_update')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_pic', models.ImageField(upload_to='alessandria/upload', verbose_name='Couverture', null=True, blank=True)),
                ('notes', models.TextField(verbose_name='Notes', null=True, blank=True)),
                ('is_isbn_import', models.BooleanField(verbose_name='Importé ISBN', default=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(verbose_name='Notes', null=True, blank=True)),
                ('book', models.ForeignKey(verbose_name='Livre', to='alessandria.Book')),
                ('condition', models.ForeignKey(verbose_name='Etat', to='alessandria.BookCondition')),
                ('created_by', models.ForeignKey(related_name='alessandria_bookcopy_add', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(blank=True, to=settings.AUTH_USER_MODEL, null=True, related_name='alessandria_bookcopy_update')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, auto_created=True, verbose_name='ID', serialize=False)),
                ('label', models.CharField(verbose_name='Description', max_length=30)),
                ('parent_category', models.ForeignKey(to='alessandria.BookCategory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(verbose_name='Notes', null=True, blank=True)),
                ('is_isbn_import', models.BooleanField(verbose_name='Importé ISBN', default=False)),
                ('created_by', models.ForeignKey(related_name='alessandria_publisher_add', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(blank=True, to=settings.AUTH_USER_MODEL, null=True, related_name='alessandria_publisher_update')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(verbose_name='Notes', null=True, blank=True)),
                ('created_by', models.ForeignKey(related_name='alessandria_reader_add', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(blank=True, to=settings.AUTH_USER_MODEL, null=True, related_name='alessandria_reader_update')),
                ('profession', models.ForeignKey(blank=True, to='alessandria.Profession', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(verbose_name='Notes', null=True, blank=True)),
                ('bookcopy', models.ForeignKey(verbose_name='Exemplaire', to='alessandria.BookCopy')),
                ('created_by', models.ForeignKey(related_name='alessandria_readerborrow_add', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(blank=True, to=settings.AUTH_USER_MODEL, null=True, related_name='alessandria_readerborrow_update')),
                ('reader', models.ForeignKey(verbose_name='Lecteur', to='alessandria.Reader')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='bookcopy',
            name='origin',
            field=models.ForeignKey(verbose_name='Origine', to='alessandria.BookCopyOrigin'),
        ),
        migrations.AddField(
            model_name='book',
            name='audiences',
            field=models.ManyToManyField(verbose_name='Public cible', to='alessandria.BookAudience'),
        ),
        migrations.AddField(
            model_name='book',
            name='authors',
            field=models.ManyToManyField(verbose_name='Auteurs', to='alessandria.Author'),
        ),
        migrations.AddField(
            model_name='book',
            name='category',
            field=models.ForeignKey(verbose_name='Catégorie', to='alessandria.BookCategory'),
        ),
        migrations.AddField(
            model_name='book',
            name='created_by',
            field=models.ForeignKey(related_name='alessandria_book_add', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='book',
            name='language',
            field=models.ForeignKey(verbose_name='Langue', to='alessandria.Language'),
        ),
        migrations.AddField(
            model_name='book',
            name='modified_by',
            field=models.ForeignKey(blank=True, to=settings.AUTH_USER_MODEL, null=True, related_name='alessandria_book_update'),
        ),
        migrations.AddField(
            model_name='book',
            name='publishers',
            field=models.ManyToManyField(verbose_name='Editeurs', to='alessandria.Publisher'),
        ),
        migrations.AddField(
            model_name='book',
            name='related_to',
            field=models.ForeignKey(verbose_name='Apparenté à', blank=True, to='alessandria.Book', null=True),
        ),
        migrations.AddField(
            model_name='book',
            name='sub_category',
            field=models.ForeignKey(verbose_name='Sous-catégorie', blank=True, to='alessandria.BookSubCategory', null=True),
        ),
        migrations.AddField(
            model_name='book',
            name='tags',
            field=models.ManyToManyField(verbose_name='Etiquettes', to='alessandria.BookTag', blank=True),
        ),
